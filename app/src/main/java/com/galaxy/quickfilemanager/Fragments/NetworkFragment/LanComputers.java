...
import com.galaxy.quickfilemanager.Fragments.NetworkFragment.Lan.Computer;
import com.galaxy.quickfilemanager.Fragments.NetworkFragment.Lan.LanListAdapter;
import com.galaxy.quickfilemanager.Fragments.NetworkFragment.Lan.SubnetScanner;
...
public class LanComputers extends Fragment {
    ...
    public void init(View view) {
        ...
        recycler_view_lan_list.addOnItemTouchListener(new RecyclerTouchListener(AppController.getInstance().getApplicationContext(), recycler_view_lan_list, new RecyclerTouchListener.ClickListener() {
            @Override
