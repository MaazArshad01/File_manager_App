...
public class EventHandler implements OnClickListener {
    ...
    public void setUpdateFileOperationViews(LinearLayout hidden_rename, LinearLayout hidden_add_favourite, LinearLayout hidden_zip, LinearLayout hidden_share, LinearLayout hidden_copy, LinearLayout hidden_move, LinearLayout hidden_delete, LinearLayout hidden_detail) {
    ...
    public void zipFile(String zipPath) {
        ...
        intent2.putExtra("files", mMultiSelectData);
    ...
    public class RecyclerViewTableRow extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
        ...
        public void disableFileOperationButton() {
            ...
            if (mMultiSelectData != null && mMultiSelectData.size() > 0) {
                for (String files : mMultiSelectData) {
        ...
        public void onBindViewHolder(RecyclerView.ViewHolder holder, int position) {
            if (holder instanceof DataViewHolder) {
                ...
                if (positions != null && positions.contains(position)) {
                    mViewHolder.multiselect_check.setImageResource(R.drawable.ic_checked);
                    // mViewHolder.mSelect.setVisibility(ImageView.VISIBLE);
                } else {
                    mViewHolder.multiselect_check.setImageResource(R.drawable.ic_uncheck);
                    // mViewHolder.mSelect.setVisibility(ImageView.GONE);
                }
        ...
        protected ArrayList<String> doInBackground(String... params) {
            ...
            switch (type) {
                ...
                case ZIP_TYPE:
                    ...
                    String selectedPath = mMultiSelectData.get(0);
                    String ZipLocation = Location;
